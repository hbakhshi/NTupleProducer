...
private:
  ...
  //saeid
  std::auto_ptr<std::vector<float> >   fTRawCombinedIsolationDBSumPtCorr3Hits;
  std::auto_ptr<std::vector<float> >   fTLooseCombinedIsolationDeltaBetaCorr;
  std::auto_ptr<std::vector<float> >   fTTightCombinedIsolationDeltaBetaCorr3Hits;
  std::auto_ptr<std::vector<float> >   fTVLooseCombinedIsolationDeltaBetaCorr;
  std::auto_ptr<std::vector<float> >   fTMediumCombinedIsolationDeltaBetaCorr;
  std::auto_ptr<std::vector<float> >   fTDeadECALElectronRejection;
  std::auto_ptr<std::vector<float> >   fTMediumCombinedIsolationDeltaBetaCorr3Hits;
  std::auto_ptr<std::vector<float> >   fTcategoryMVA3ElectronRejection;
  std::auto_ptr<std::vector<float> >   fTTightCombinedIsolationDeltaBetaCorr;
  std::auto_ptr<std::vector<float> >   fTrawMVA3ElectronRejection;
  std::auto_ptr<std::vector<float> >   fTLooseCombinedIsolationDeltaBetaCorr3Hits;
  std::auto_ptr<std::vector<float> >   fTCombinedIsolationDeltaBetaCorrRaw;
  //saeid
...
const std::vector<filler::PPair> LeptonFillerPat<LeptonType>::declareProducts(void) {
  ...
  if(fType == Tau){
    ...
    //saeid
    addProduct("RawCombinedIsolationDBSumPtCorr3Hits", typeid(*fTRawCombinedIsolationDBSumPtCorr3Hits));
    addProduct("LooseCombinedIsolationDeltaBetaCorr", typeid(*fTLooseCombinedIsolationDeltaBetaCorr));
    addProduct("TightCombinedIsolationDeltaBetaCorr3Hits", typeid(*fTTightCombinedIsolationDeltaBetaCorr3Hits));
    addProduct("VLooseCombinedIsolationDeltaBetaCorr", typeid(*fTVLooseCombinedIsolationDeltaBetaCorr));
    addProduct("MediumCombinedIsolationDeltaBetaCorr", typeid(*fTMediumCombinedIsolationDeltaBetaCorr));
    addProduct("DeadECALElectronRejection", typeid(*fTDeadECALElectronRejection));
    addProduct("MediumCombinedIsolationDeltaBetaCorr3Hits", typeid(*fTMediumCombinedIsolationDeltaBetaCorr3Hits));
    addProduct("categoryMVA3ElectronRejection", typeid(*fTcategoryMVA3ElectronRejection));
    addProduct("TightCombinedIsolationDeltaBetaCorr", typeid(*fTTightCombinedIsolationDeltaBetaCorr));
    addProduct("rawMVA3ElectronRejection", typeid(*fTrawMVA3ElectronRejection));
    addProduct("LooseCombinedIsolationDeltaBetaCorr3Hits", typeid(*fTLooseCombinedIsolationDeltaBetaCorr3Hits));
    addProduct("CombinedIsolationDeltaBetaCorrRaw", typeid(*fTCombinedIsolationDeltaBetaCorrRaw));
    //saeid
...
void LeptonFillerPat<LeptonType>::putProducts(edm::Event& e) {
  ...
  if(fType == Tau){
    ...
    //saeid
    e.put(fTRawCombinedIsolationDBSumPtCorr3Hits,fullName("RawCombinedIsolationDBSumPtCorr3Hits"));
    e.put(fTLooseCombinedIsolationDeltaBetaCorr,fullName("LooseCombinedIsolationDeltaBetaCorr"));
    e.put(fTTightCombinedIsolationDeltaBetaCorr3Hits,fullName("TightCombinedIsolationDeltaBetaCorr3Hits"));
    e.put(fTVLooseCombinedIsolationDeltaBetaCorr,fullName("VLooseCombinedIsolationDeltaBetaCorr"));
    e.put(fTMediumCombinedIsolationDeltaBetaCorr,fullName("MediumCombinedIsolationDeltaBetaCorr"));
    e.put(fTDeadECALElectronRejection,fullName("DeadECALElectronRejection"));
    e.put(fTMediumCombinedIsolationDeltaBetaCorr3Hits,fullName("MediumCombinedIsolationDeltaBetaCorr3Hits"));
    e.put(fTcategoryMVA3ElectronRejection,fullName("categoryMVA3ElectronRejection"));
    e.put(fTTightCombinedIsolationDeltaBetaCorr,fullName("TightCombinedIsolationDeltaBetaCorr"));
    e.put(fTrawMVA3ElectronRejection,fullName("rawMVA3ElectronRejection"));
    e.put(fTLooseCombinedIsolationDeltaBetaCorr3Hits,fullName("LooseCombinedIsolationDeltaBetaCorr3Hits"));
    e.put(fTCombinedIsolationDeltaBetaCorrRaw,fullName("CombinedIsolationDeltaBetaCorrRaw"));
    //saeid
...
void LeptonFillerPat<LeptonType>::resetProducts(void) {
  ...
  if(fType == Tau){
    ...
    //saeid
    fTRawCombinedIsolationDBSumPtCorr3Hits.reset(new std::vector<float>);
    fTLooseCombinedIsolationDeltaBetaCorr.reset(new std::vector<float>);
    fTTightCombinedIsolationDeltaBetaCorr3Hits.reset(new std::vector<float>);
    fTVLooseCombinedIsolationDeltaBetaCorr.reset(new std::vector<float>);
    fTMediumCombinedIsolationDeltaBetaCorr.reset(new std::vector<float>);
    fTDeadECALElectronRejection.reset(new std::vector<float>);
    fTMediumCombinedIsolationDeltaBetaCorr3Hits.reset(new std::vector<float>);
    fTcategoryMVA3ElectronRejection.reset(new std::vector<float>);
    fTTightCombinedIsolationDeltaBetaCorr.reset(new std::vector<float>);
    fTrawMVA3ElectronRejection.reset(new std::vector<float>);
    fTLooseCombinedIsolationDeltaBetaCorr3Hits.reset(new std::vector<float>);
    fTCombinedIsolationDeltaBetaCorrRaw.reset(new std::vector<float>);
    //saeid
...
void LeptonFillerPat<pat::Tau>::getSpecific(const pat::Tau& lepton){
  ...
  //organized by Hamed
  fTDeadECALElectronRejection->push_back( lepton.tauID("againstElectronDeadECAL") );
  ...
  fTcategoryMVA3ElectronRejection->push_back( lepton.tauID("againstElectronMVA3category") );
  fTrawMVA3ElectronRejection->push_back( lepton.tauID("againstElectronMVA3raw") );
  ...
  fTCombinedIsolationDeltaBetaCorrRaw->push_back( lepton.tauID("byCombinedIsolationDeltaBetaCorrRaw") );
  fTRawCombinedIsolationDBSumPtCorr3Hits->push_back( lepton.tauID("byCombinedIsolationDeltaBetaCorrRaw3Hits") );
  fTIsolationMVA2raw->push_back( lepton.tauID("byIsolationMVA2raw") );
  fTIsolationMVAraw->push_back( lepton.tauID("byIsolationMVAraw") );
  fTLooseCombinedIsolationDeltaBetaCorr->push_back( lepton.tauID("byLooseCombinedIsolationDeltaBetaCorr") );
  fTLooseCombinedIsolationDeltaBetaCorr3Hits->push_back( lepton.tauID("byLooseCombinedIsolationDeltaBetaCorr3Hits") );
  ...
  fTMediumCombinedIsolationDeltaBetaCorr->push_back( lepton.tauID("byMediumCombinedIsolationDeltaBetaCorr") );
  fTMediumCombinedIsolationDeltaBetaCorr3Hits->push_back( lepton.tauID("byMediumCombinedIsolationDeltaBetaCorr3Hits") );
  ...
  fTTightCombinedIsolationDeltaBetaCorr->push_back( lepton.tauID("byTightCombinedIsolationDeltaBetaCorr") );
  fTTightCombinedIsolationDeltaBetaCorr3Hits->push_back( lepton.tauID("byTightCombinedIsolationDeltaBetaCorr3Hits") );
  ...
  fTVLooseCombinedIsolationDeltaBetaCorr->push_back( lepton.tauID("byVLooseCombinedIsolationDeltaBetaCorr") );
  ...
  fTLooseChargedIso ->push_back( lepton.tauID("againstMuonLoose3") );
  fTTightChargedIso ->push_back( lepton.tauID("againstMuonTight3") );
